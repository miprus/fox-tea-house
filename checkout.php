...
<head>
    ...
    <meta name="description" content="FoxTeaHouse - checkout page. Review an order before buying it.">
...
<main class="container-fluid">
	...
	<article class="checkout_box">
		<h2 class="text-center mt-5">Checkout Summary</h2>
			<div class="d-flex justify-content-center">
				<img src="img/logo/fth_logo.svg" alt="fth logo" class="logo_small">
			</div>
		<hr>

		<?php
			require_once 'php/elements/get_checkout_items.php';
		?>
	</article>
