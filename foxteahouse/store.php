...
<head>
    ...
    <meta name="description" content="FoxTeaHouse - dynamic store page.">
    ...
    <title>Fox Tea House - Store</title>
...
<main class="container-fluid">
	<?php
		...
		require 'php/elements/pagination.php';
	?>

	<section class="row row-cols-1 row-cols-lg-2 row-cols-xl-3 store_list">
		<?php
			require_once 'php/elements/get_product_list.php';
		?>
	</section>
